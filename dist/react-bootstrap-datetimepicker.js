	  ...
	  function DateTimeField() {
	    ...
	    this.componentWillMount = function () {
	      if (_this.props.defaultValue) {
	        _this.setState({
	          viewDate: (0, _moment2["default"])(_this.props.defaultValue, _this.props.format, true).startOf("month"),
	          selectedDate: (0, _moment2["default"])(_this.props.defaultValue, _this.props.format, true),
	          inputValue: (0, _moment2["default"])(_this.props.defaultValue, _this.props.format, true).format(_this.resolvePropsInputFormat())
	        });
	      }

	      if (_this.props.locale) _moment2["default"].locale(_this.props.locale);
	    };
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement("span", { className: (0, _classnames2["default"])("glyphicon", "glyphicon-remove") })
	          ),
	          _react2["default"].createElement(
	            "span",
	      ...
	      if (_this.props.showDatePicker) {
	        return _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(_DateTimePickerDateJs2["default"], {
	            ...
	            calendarWeeks: _this.props.calendarWeeks,
	      ...
	      while (prevMonth.isBefore(nextMonth)) {
	        ...
	        if (_this.props.calendarWeeks && cells.length % 8 === 0) {
	          cells.push(_react2["default"].createElement(
	            "td",
	            { className: "cw", key: prevMonth.year() + "-" + prevMonth.week() },
	            prevMonth.week()
	          ));
	        }
	        cells.push(_react2["default"].createElement(
